...
if __name__ == '__main__':
    ...
    #arg = '-fd ../models/intel/face-detection-adas-0001/FP32/face-detection-adas-0001 -fl ../models/intel/landmarks-regression-retail-0009/FP32/landmarks-regression-retail-0009 -hp ../models/intel/head-pose-estimation-adas-0001/FP32/head-pose-estimation-adas-0001 -ge ../models/intel/gaze-estimation-adas-0002/FP32/gaze-estimation-adas-0002 -i ../media/demo.mp4 -d CPU -pof fd fl hp ge'.split(' ')
    #arg = '-fd ../models/intel/face-detection-adas-0001/FP32/face-detection-adas-0001 -fl ../models/intel/landmarks-regression-retail-0009/FP16-INT8/landmarks-regression-retail-0009 -hp ../models/intel/head-pose-estimation-adas-0001/FP16-INT8/head-pose-estimation-adas-0001 -ge ../models/intel/gaze-estimation-adas-0002/FP16-INT8/gaze-estimation-adas-0002 -i ../media/demo.mp4 -d CPU -pof fd fl hp ge'.split(' ')
